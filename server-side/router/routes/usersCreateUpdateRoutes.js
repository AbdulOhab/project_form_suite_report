...
router.post("/update-branch-password/:id", usersController.updateBranchPassword);
router.post("/get-thana-users-for-update/:id", usersController.getThanaUsersUpdate);
...
router.get("/get-branch-users-by-zonal/:zonalId", usersController.getBranchByZonal);
